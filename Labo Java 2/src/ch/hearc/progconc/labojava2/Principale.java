 ...
 * Nous avons représenté la barrière avec la classe Barrier qui contient autant de CyclicBarrier que de type d'objets rentrant. <br />
 * Pour cela, nous les stockons dans une Map.
 * 
 * Lorsqu'un objet touche la barrière, représentée par une ligne, celui-ci appelle la méthode iWantToPass, qui va le mettre en attente.<br />
 * Une fois que 3 objets du même types sont présents, la barrière les libère, les laisse repartir et attend à nouveau 3 objets du même type.
 * <br />
 ...
 * <br />3) Nous réinitialisons la barrière, avec la méthode resetBarrier, appelant la méthode clear de la classe CyclicBarrier.
 * 
 * 
 ...
 * objets repartent correctement sans s'arrêter à nouveau. Les autres objets du même type s'arrêtent devant la barrière en attendant d'être 3 
 * (sans compter ceux qui viennet de partir).<br />
